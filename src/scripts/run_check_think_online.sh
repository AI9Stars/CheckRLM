...
echo "Start running check think online"
echo "Project root: ${PROJECT_ROOT}, VLLM API Key: ${VLLM_API_KEY}, Reasoning base url: ${REASONING_BASE_URL}, Check base url: ${CHECK_BASE_URL}, Elasticsearch url: ${ES_URL}"

python -u $PROJECT_ROOT/src/tasks/check_think_online.py \
...
echo "Check think online finished."
